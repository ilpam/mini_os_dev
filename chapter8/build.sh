...
echo "linking..."
ld -m elf_i386 ./build/main.o ./build/print.o ./build/kernel.o ./build/init.o ./build/interrupt.o ./build/timer.o ./build/debug.o -Ttext 0xc0001500 -e main -o ./build/kernel.elf
