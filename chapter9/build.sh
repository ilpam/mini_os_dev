...
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./kernel/init.c -o ./build/init.o
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./kernel/interrupt.c -o ./build/interrupt.o
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./device/timer.c -o ./build/timer.o
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./kernel/debug.c -o ./build/debug.o
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./lib/string.c -o ./build/string.o
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./lib/kernel/bitmap.c -o ./build/bitmap.o
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./kernel/memory.c -o ./build/memory.o
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./thread/thread.c -o ./build/thread.o
gcc -Wall -m32 -fno-builtin -fno-stack-protector -I ./lib/kernel/ -I ./lib/ -I ./kernel/ -I ./thread/ -c ./lib/kernel/list.c -o ./build/list.o
